...
export const carpetRules: CarpetRule[] = [
    {
      ...
      value: "True",
      desc: "Esta Carpet Rule corrige un error en la interfaz de crafteo donde, al usar Ctrl + Q para craftear un stack de ítems y dropearlos, los items quedan en el inventario en lugar de ser dropeados. Al activar esta opción, el juego maneja mejor esta acción y garantiza que el stack se drope completamente."
    },
    {
      name: "defaultLoggers",
      value: "tps",
    ...
    },
    {
      name: "fogOff",
      value: "True",
      desc: "Esta Carpet Rule desactiva la niebla para mejorar la visibilidad en el Nether. A continuación se muestra una imagen con el cambio:",
      image: "/images/carpet-rules/nether-fog.webp"
    },
    {
